...
export async function storePublicImageFromBase64(base64Image: string): Promise<string> {
...
export const getStorageConnectionString = () => {
    if (isNullOrUndefined(process.env.AzureWebJobsStorage) || process.env.AzureWebJobsStorage === "") {
