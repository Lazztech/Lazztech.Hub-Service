...
export class Migration20220202034907 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    // this.addSql('alter table "user" add constraint "REL_5d250ff0a3f3eba15ff2db819d" unique ("passwordResetId");');

    // this.addSql('create table "user_device" ("id" serial primary key, "fcmPushUserToken" varchar(255) not null, "userId" int not null);');
    // this.addSql('alter table "user_device" add constraint "UQ_9fa10355d40f3311b221b15c04c" unique ("fcmPushUserToken");');
    ...
    // this.addSql('alter table "invite" add constraint "IDX_c8772f9bcb1e9f4faaa9c8873d" unique ("invitersId", "inviteesId", "hubId");');
