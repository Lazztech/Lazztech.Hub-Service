...
export class lastGeofenceEvent1641361229812 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_join_user_hub"("userId", "hubId", "isOwner", "starred", "isPresent", "lastUpdated") SELECT "userId", "hubId", "isOwner", "starred", "isPresent", "lastUpdated" FROM "join_user_hub"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "join_user_hub"("userId", "hubId", "isOwner", "starred", "isPresent", "lastUpdated") SELECT "userId", "hubId", "isOwner", "starred", "isPresent", "lastUpdated" FROM "temporary_join_user_hub"`);
